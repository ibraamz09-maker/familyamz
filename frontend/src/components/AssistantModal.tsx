      ...
      <div style={{
        ...
        {step === 'listen' && (
          <div style={{ textAlign: 'center' }}>
            ...
            <button onClick={onClose} style={{ marginTop: 16, background: 'none', border: 'none', color: 'var(--text-2)', fontSize: 13, cursor: 'pointer' }}>
              Fermer
            </button>
          </div>
        )}
        ...
        {step === 'confirm' && result && info && (
          <div>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              {result.action !== 'unknown' && (
                <button className="btn-primary" style={{ flex: 2, padding: '12px' }} onClick={execute}>
                  ✅ Accepter
                </button>
              )}
        ...
        {step === 'error' && (
          <div style={{ textAlign: 'center', padding: '20px 0' }}>
            ...
            <button className="btn-secondary" style={{ marginTop: 16 }} onClick={() => { setStep('listen'); setError(''); }}>
              Réessayer
            </button>
          </div>
        )}
